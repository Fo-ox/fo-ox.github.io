...
const user1 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](1, new Date("2014-01-01"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](1, "8(800)000-00-01", "a@yandex.ru"), "Никита", "Давидов", "Олегович", 4.44, "A-102");
const user2 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](2, new Date("2014-04-30"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](2, "8(800)000-00-02"), "Ольга", "Майорова", "Андреевна", 2.38, "A-101");
const user3 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](3, new Date("2015-11-01"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](3, "", "b@yandex.ru"), "Андрей", "Дунаев", "Васильевич", 2, "A-105");
const user4 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](4, new Date("2018-12-17"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](4), "Виктор", "Долголетов", "Анатольевич", 1, "A-101");
const user5 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](5, new Date("2015-01-11"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](5), "Анна", "Тихомирова", "Сергеевна", 3.5, "A-101");
const user6 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](6, new Date("2012-05-19"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](6), "Никита", "Гридин", "Юрьевич", 5, "A-103");
const user7 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](7, new Date("2013-08-24"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](7), "Никита", "Шилов", "Максимович", 4.44, "A-102");
const user8 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](8, new Date("2012-12-12"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](8), "Кристина", "Кондракова", "Васильевна", 5, "A-103");
class TestData {
}
