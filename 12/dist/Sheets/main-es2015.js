...
let ControlService = class ControlService {
    ...
    sortList(list, sortType) {
        ...
        switch (sortType) {
            case "id": {
                return returnArray.sort((a, b) => a.id < b.id ? -1 : 1);
                break;
            }
            case "name": {
                return returnArray.sort((a, b) => a.name < b.name ? -1 : 1);
                break;
            }
            case "surname": {
                return returnArray.sort((a, b) => a.surname < b.surname ? -1 : 1);
                break;
            }
            case "patronymic": {
                return returnArray.sort((a, b) => a.patronymic < b.patronymic ? -1 : 1);
                break;
            }
            case "age": {
                return returnArray.sort((a, b) => a.date.getFullYear() > b.date.getFullYear() ? -1 : 1);
                break;
            }
            case "points": {
                return returnArray.sort((a, b) => a.points < b.points ? -1 : 1);
                break;
            }
            case "group": {
                return returnArray.sort((a, b) => a.group < b.group ? -1 : 1);
                break;
            }
        }
...
const user1 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](1, new Date("1995-10-11"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](1, "8(800)000-00-01", "a@yandex.ru"), "Никита", "Давидов", "Олегович", 4, "A-102");
const user2 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](2, new Date("1994-04-30"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](2, "8(800)000-00-02"), "Ольга", "Майорова", "Андреевна", 5, "A-101");
const user3 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](3, new Date("1995-02-01"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](3, "", "b@yandex.ru"), "Андрей", "Дунаев", "Васильевич", 2, "A-105");
const user4 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](4, new Date("1998-12-30"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](4), "Виктор", "Долголетов", "Анатольевич", 1, "A-101");
const user5 = new _model_user__WEBPACK_IMPORTED_MODULE_2__["User"](5, new Date("1995-10-11"), new _model_contact__WEBPACK_IMPORTED_MODULE_1__["Contact"](5), "Анна", "Тихомирова", "Сергеевна", 3, "A-101");
